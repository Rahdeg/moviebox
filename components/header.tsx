...
const Header = () => {
    ...
    return (
        <header className={cn(" flex items-center justify-between px-16 bg-black py-3", isScrolled && 'bg-[#141414]')}>
            <div className="w-[186px] h-[50px] justify-start items-center gap-6 inline-flex">
                <Image
                    alt='logo'
                    width={50}
                    height={50}
                    className="w-[50px] h-[50px]" src="/tv.png"
                />
                <div className="text-white text-2xl font-bold leading-normal">MovieBox</div>
            </div>

            <SearchInput />

            <div className=" h-9 justify-start items-center gap-[27px] inline-flex">
                <div className="text-white text-base font-bold leading-normal">Sign in</div>
