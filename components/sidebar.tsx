...
const Sidebar = () => {
    ...
    return (
        <div className=" space-y-4 py-4 flex flex-col  items-center justify-center rounded- text-white w-[226px] h-full bg-white rounded-tr-[45px] rounded-br-[45px] border border-black border-opacity-30">
            <div className=" py-2 flex-1">
                <Link href='/' className=" flex items-center pl-3 mb-6 py-2">
                    <div className="relative w-8 h-8 mr-4">
                        <Image src='/tv.png' alt="logo" fill />
                    </div>
                    <h1 className={cn(" text-2xl text-black font-bold", montserrat.className)}>MovieBox</h1>
                </Link>
                <div className=" space-y-4 items-center  w-full mb-3 ">
                    {
                        routes.map((route) => (
                ...
                <Button className="w-full flex items-center justify-center text-gray-400 ml-auto" variant="ghost">
